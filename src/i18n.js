...
const messages = {
  en: {
    ...
    geolocationPositionUnavailable: 'Unable to determine your location!',
    geolocationTimeout: 'Geolocation request timed out!',
    geolocationGenericError: 'Geolocation error: {message}',
  ...
  ru: {
    ...
    geolocationPositionUnavailable: 'Не удалось определить ваше местоположение!',
    geolocationTimeout: 'Время ожидания запроса геолокации истекло!',
    geolocationGenericError: 'Ошибка геолокации: {message}',
